# Generated by Django 5.0.6 on 2025-03-20 09:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aadhar_id', models.CharField(help_text='Enter a 12-digit numeric Aadhar ID.', max_length=12, unique=True, validators=[farmers.models.validate_aadhar_id])),
                ('farm_area', models.FloatField()),
                ('created_at', models.DateTimeField()),
                ('last_updated_at', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(blank=True, default='farmer_images/default.jpg', null=True, upload_to='farmer_images/')),
